...
#release sub-revision (digits after 0.99.21mr2.2-)
%{!?release_rev:	%define		release_rev	1 }

Summary: Routing daemon
Name:		quagga
Version:	0.99.21mr2.2
Release:	%{release_rev}
License:	GPL
Group: System Environment/Daemons
Source0:	http://downloads.pf.itd.nrl.navy.mil/ospf-manet/%{name}-%{version}.tar.gz
URL:		http://cs.itd.nrl.navy.mil/work/ospf-manet/index.php
%if %{with_snmp}
...
Requires:	ncurses
%endif
BuildRequires:	texinfo texinfo-tex tetex autoconf patch libcap-devel tetex texi2html ImageMagick
%if %{with_pam}
