...
/* subtract b from a and return the number of seconds */
long
timersub_sec (struct timeval *a, struct timeval *b)
{
  struct timeval delta;

  timersub (a, b, &delta);

  return (long) delta.tv_sec + (long) delta.tv_usec / 1000000;
}

/* subtract b from a and return the number of milliseconds */
long
timersub_msec (struct timeval *a, struct timeval *b)
{
  struct timeval delta;

  timersub (a, b, &delta);

  return (long) delta.tv_sec * 1000 + (long) delta.tv_usec / 1000;
}

static unsigned int
