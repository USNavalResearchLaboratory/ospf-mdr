...
extern void zclient_serv_path_set  (const char *path);
...
extern int zclient_send_linkmetrics_subscribe (struct zclient *zclient,
					       uint16_t cmd);
extern int zclient_linkmetrics_subscribe (struct zclient *zclient,
					  uint16_t cmd);
