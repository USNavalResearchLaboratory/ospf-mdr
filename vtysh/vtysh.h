...
#define VTYSH_XPIMD  0x100
#endif  /* QUAGGA_MULTICAST */
#ifdef QUAGGA_MULTICAST
#define VTYSH_ALL	  VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_BGPD|VTYSH_ISISD|VTYSH_BABELD|VTYSH_XPIMD
#else
...
#ifdef QUAGGA_MULTICAST
#define VTYSH_INTERFACE	  VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_ISISD|VTYSH_BABELD|VTYSH_XPIMD
#else
