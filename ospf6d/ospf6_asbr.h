...
extern void ospf6_asbr_delete (struct ospf6 *o);
extern void ospf6_asbr_external_table_finish (struct ospf6_route_table *external_table);
extern void ospf6_asbr_redistribute_enable (struct ospf6 *o);
extern void ospf6_asbr_redistribute_disable (struct ospf6 *o);
...
extern void ospf6_asbr_redistribute_remove (int type, int ifindex,
                                            struct prefix *prefix);
extern void ospf6_asbr_redistribute_remove_connected (struct ospf6_interface *oi);
