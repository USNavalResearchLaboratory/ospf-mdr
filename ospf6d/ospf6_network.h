...
#define OSPF6_DEFAULT_IPV6_TCLASS IPTOS_PREC_INTERNETCONTROL
#else
#define OSPF6_DEFAULT_IPV6_TCLASS 0
#endif
...
extern int ospf6_set_transport_class (int tclass);
extern void ospf6_set_checksum (void);
extern int ospf6_set_multicast_hops (int hoplimit);
