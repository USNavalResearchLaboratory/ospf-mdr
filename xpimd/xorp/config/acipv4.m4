...
#endif
"]
  AC_DEFINE(HAVE_LINUX_MROUTE_H, 1, [Define to 1 if you have the <linux/mroute.h> header file.])],
  [test_linux_mroute_h=""
   test_linux_mroute_h_missing_defines=""
], [#include <netinet/in.h>])
...
AC_CHECK_DECL([VIFF_USE_IFINDEX],
 [AC_DEFINE(HAVE_VIFF_USE_IFINDEX, 1,
	   [Define to 1 if you have VIFF_USE_IFINDEX])], ,
 [${test_multicast_routing_header_files}])
